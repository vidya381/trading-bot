...
| [10-frontend.md](10-frontend.md) | 10.6, 10.8, 10.9, 10.10, 10.11 | Dashboard frontend scaffolding and bot list; bot detail view; liquidate action; global kill switch control; create-bot form |
