 ...
 *   /bots/:id    the bot detail view -- a placeholder this session (next session)
...
import { BotDetailPlaceholder } from "./pages/BotDetailPlaceholder";
    ...
    <div className="flex min-h-full flex-col">
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-6 sm:px-6 lg:px-8">
        <Routes>
          ...
          <Route path="/bots/:id" element={<BotDetailPlaceholder />} />
